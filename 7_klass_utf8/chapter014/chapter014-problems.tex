...
ight.$\\
87. Корнем первого уравнения является $x=-\cfrac{1}{6},$ подставим его во второе уравнение: $2\cdot\left(-\cfrac{1}{6}
...
99. $\cfrac{3-2x}{6}-\left(1,5+\cfrac{4x-7}{3}
...
101. $\cfrac{2-3x}{4}-\left(\cfrac{x-4}{3}-x
...
107. $(|x+2|-a)(x+1)=0\Leftrightarrow \left[\begin{array}{l}|x+2|-a=0,\\ x+1=0.\end{array}
ight.\Leftrightarrow
\left[\begin{array}{l}
\begin{cases}
\left[\begin{array}{l}
...
109. $\left(\cfrac{6x-1}{x^2+6x}+\cfrac{6x+1}{x^2-6x}
ight):\cfrac{x^2+1}{x^2-36}-\cfrac{12}{x-1}=\cfrac{12}{x-x^2}\Leftrightarrow
...
eq1.\end{cases}\Leftrightarrow x
otin\{-6;0;1;6\}$\\
112. $(x^2-3x+1)^2-(x^2-2x-1)^2=0,\ (x^2-3x+1-x^2+2x+1)(x^2-3x+1+x^2-2x-1)=0,\ (2-x)(2x^2-5x)=0,\ (2-x)x(2x-5)=0,\ x\in\left\{0;2;\cfrac{5}{2}
ight\}.$\\
